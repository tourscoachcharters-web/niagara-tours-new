...
// --- Social Icon Components (Inline SVG to avoid Lucide Export Errors) ---
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#F8A41E] hover:text-[#0C3136] transition-all cursor-pointer"><FacebookIcon className="w-4 h-4" /></div>
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#F8A41E] hover:text-[#0C3136] transition-all cursor-pointer"><InstagramIcon className="w-4 h-4" /></div>
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#F8A41E] hover:text-[#0C3136] transition-all cursor-pointer"><TwitterIcon className="w-4 h-4" /></div>
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#F8A41E] hover:text-[#0C3136] transition-all cursor-pointer"><YoutubeIcon className="w-4 h-4" /></div>
              </div>
            </div>
            <div>
